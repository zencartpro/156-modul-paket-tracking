 ...
 * @version $Id: orders.php for Paket Tracking 2019-08-07 15:31:51Z webchills $
 */
...
// BEGIN PAKET TRACKING ------------------------------
    $orders_history = $db->Execute("select orders_status_id, date_added, customer_notified, track_id1, track_id2, track_id3, track_id4, track_id5, track_id6, track_day, track_month, track_year, comments, updated_by
